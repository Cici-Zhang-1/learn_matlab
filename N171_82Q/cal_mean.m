...
[h,mean_value.MH_MW_P_Value(1),ci,stats] = ttest2(MH{'Brain', :}',MW{'Brain', :}', 'Vartype', Vartype);
[h,mean_value.FH_FW_P_Value(1),ci,stats] = ttest2(FH{'Brain', :}',FW{'Brain', :}', 'Vartype', Vartype);
[h,mean_value.M_F_P_Value(1),ci,stats] = ttest2((MH{'Brain', :} + FH{'Brain', :})',(MW{'Brain', :} + FW{'Brain', :})', 'Vartype', Vartype);
...
[h,mean_value.MH_MW_P_Value(2),ci,stats] = ttest2(MH_Combine{'CaudatePutamen', :}',MW_Combine{'CaudatePutamen', :}', 'Vartype', Vartype);
[h,mean_value.FH_FW_P_Value(2),ci,stats] = ttest2(FH_Combine{'CaudatePutamen', :}',FW_Combine{'CaudatePutamen', :}', 'Vartype', Vartype);
[h,mean_value.M_F_P_Value(2),ci,stats] = ttest2((MH_Combine{'CaudatePutamen', :} + FH_Combine{'CaudatePutamen', :})',...
    (MW_Combine{'CaudatePutamen', :} + FW_Combine{'CaudatePutamen', :})', 'Vartype', Vartype);
...
[h,mean_value.MH_MW_P_Value(3),ci,stats] = ttest2(MH_Combine{'Neocortex', :}',MW_Combine{'Neocortex', :}', 'Vartype', Vartype);
[h,mean_value.FH_FW_P_Value(3),ci,stats] = ttest2(FH_Combine{'Neocortex', :}',FW_Combine{'Neocortex', :}', 'Vartype', Vartype);
[h,mean_value.M_F_P_Value(3),ci,stats] = ttest2((MH_Combine{'Neocortex', :} + FH_Combine{'Neocortex', :})',...
    (MW_Combine{'Neocortex', :} + FW_Combine{'Neocortex', :})', 'Vartype', Vartype);
...
[h,mean_value.MH_MW_P_Value(4),ci,stats] = ttest2(MH_Combine{'Cerebellum', :}',MW_Combine{'Cerebellum', :}', 'Vartype', Vartype);
[h,mean_value.FH_FW_P_Value(4),ci,stats] = ttest2(FH_Combine{'Cerebellum', :}',FW_Combine{'Cerebellum', :}', 'Vartype', Vartype);
[h,mean_value.M_F_P_Value(4),ci,stats] = ttest2((MH_Combine{'Cerebellum', :} + FH_Combine{'Cerebellum', :})',...
    (MW_Combine{'Cerebellum', :} + FW_Combine{'Cerebellum', :})', 'Vartype', Vartype);
...
[h,mean_value.MH_MW_P_Value(5),ci,stats] = ttest2(MH_Combine{'Thalamus', :}',MW_Combine{'Thalamus', :}', 'Vartype', Vartype);
[h,mean_value.FH_FW_P_Value(5),ci,stats] = ttest2(FH_Combine{'Thalamus', :}',FW_Combine{'Thalamus', :}', 'Vartype', Vartype);
[h,mean_value.M_F_P_Value(5),ci,stats] = ttest2((MH_Combine{'Thalamus', :} + FH_Combine{'Thalamus', :})',...
    (MW_Combine{'Thalamus', :} + FW_Combine{'Thalamus', :})', 'Vartype', Vartype);
...
[h,mean_value.MH_MW_P_Value(6),ci,stats] = ttest2(MH_Combine{'PeriformCortex', :}',MW_Combine{'PeriformCortex', :}', 'Vartype', Vartype);
[h,mean_value.FH_FW_P_Value(6),ci,stats] = ttest2(FH_Combine{'PeriformCortex', :}',FW_Combine{'PeriformCortex', :}', 'Vartype', Vartype);
[h,mean_value.M_F_P_Value(6),ci,stats] = ttest2((MH_Combine{'PeriformCortex', :} + FH_Combine{'PeriformCortex', :})',...
    (MW_Combine{'PeriformCortex', :} + FW_Combine{'PeriformCortex', :})', 'Vartype', Vartype);
...
[h,mean_value.MH_MW_P_Value(7),ci,stats] = ttest2(MH_Combine{'Hypothalamus', :}',MW_Combine{'Hypothalamus', :}', 'Vartype', Vartype);
[h,mean_value.FH_FW_P_Value(7),ci,stats] = ttest2(FH_Combine{'Hypothalamus', :}',FW_Combine{'Hypothalamus', :}', 'Vartype', Vartype);
[h,mean_value.M_F_P_Value(7),ci,stats] = ttest2((MH_Combine{'Hypothalamus', :} + FH_Combine{'Hypothalamus', :})',...
    (MW_Combine{'Hypothalamus', :} + FW_Combine{'Hypothalamus', :})', 'Vartype', Vartype);
...
[h,mean_value.MH_MW_P_Value(8),ci,stats] = ttest2(MH_Combine{'CC/ExternalCapsule', :}',MW_Combine{'CC/ExternalCapsule', :}', 'Vartype', Vartype);
[h,mean_value.FH_FW_P_Value(8),ci,stats] = ttest2(FH_Combine{'CC/ExternalCapsule', :}',FW_Combine{'CC/ExternalCapsule', :}', 'Vartype', Vartype);
[h,mean_value.M_F_P_Value(8),ci,stats] = ttest2((MH_Combine{'CC/ExternalCapsule', :} + FH_Combine{'CC/ExternalCapsule', :})',...
    (MW_Combine{'CC/ExternalCapsule', :} + FW_Combine{'CC/ExternalCapsule', :})', 'Vartype', Vartype);
